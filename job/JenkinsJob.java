...
public class JenkinsJob
  implements JenkinsJobRunner
{
  private static final Logger log = Logger.getLogger(JenkinsJob.class);
  ...
  @Autowired
  public JenkinsJob(TestRunService testRunService, JenkinsService jenkinsService, TestCycleService cycleService)
  {
  ...
  public JobRunnerResponse runJob(JobRunnerRequest jrRequest)
  {
    ...
    List<AutomationRunStepOutputBean> aRunSteps = testRunService.getExecutingAutomationRunSteps("Jenkins");
    ...
    try
    {
      Object automationBuildDetailOutputBeans = cycleService.getRunningCycleAutomationDetail("Jenkins");
